                                ...
                                <tbody>
                                    @foreach ($paths as $path)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('coordinator.paths.destroy',$path->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('coordinator.paths.show',$path->id) }}"><i class="fa fa-fw fa-eye"></i>عرض</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('coordinator.paths.edit',$path->id) }}"><i class="fa fa-fw fa-edit"></i>تعديل</a>
                                                    @csrf
                                                    @method('DELETE')
