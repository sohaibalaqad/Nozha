...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            ...
            <form method="POST" action="{{ route('reg.coor') }}" class="login100-form validate-form">
                @csrf
...
{{--                    <x-input-error :messages="$errors->get('name')" class="mt-2" />--}}
                ...
                <div class="wrap-input100 validate-input">
                    <input id="username" type="text" class="input100  @error('username') is-invalid @enderror" name="username" placeholder="اسم المستخدم" value="{{ old('اسم المستخدم') }}" required>
{{--                    <x-input-error :messages="$errors->get('username')" class="mt-2" />--}}
                ...
                <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
                    <input class="input100  @error('email') is-invalid @enderror" type="email" name="email" placeholder="البريد الإلكتروني">
                    @error('email')
                    <span class="invalid-feedback" role="alert">
...
{{--                    <x-input-error :messages="$errors->get('email')" class="mt-2" />--}}
                ...
                <div class="wrap-input100 validate-input" data-validate = "Valid phone is required">
                    <input class="input100  @error('phone_number') is-invalid @enderror" type="text" name="phone_number" placeholder="رقم الهاتف">
                    @error('phone_number')
                    <span class="invalid-feedback" role="alert">
